...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("capability_id", sa.String(26), primary_key=True),
        sa.Column("provider", sa.String(64), nullable=False),
        sa.Column("model", sa.String(128), nullable=False),
        sa.Column("config_id", sa.String(128), nullable=False),
        sa.Column("matrix_version", sa.String(64), nullable=False),
        ...
        sa.Column("privacy_json", sa.Text(), nullable=False),
    ...
    op.create_index(
        "ix_provider_capability_identity",
        "provider_capabilities",
        ["provider", "model", "config_id", "region", "matrix_version"],
    )
    op.create_table(
        "provider_probe_runs",
        sa.Column("probe_id", sa.String(26), primary_key=True),
        sa.Column("provider", sa.String(64), nullable=False),
        sa.Column("model", sa.String(128), nullable=False),
        sa.Column("config_id", sa.String(128), nullable=False),
        sa.Column("matrix_hash", sa.String(64), nullable=False),
        sa.Column("probe_type", sa.String(8), nullable=False),
        sa.Column("region", sa.String(16), nullable=False),
        ...
        sa.Column("external_request_id", sa.String(256)),
        sa.Column("created_at", sa.String(32), nullable=False),
        sa.CheckConstraint("probe_type IN ('MOCK','LIVE')", name="ck_provider_probe_type"),
    )
    op.create_table(
        "provider_role_promotions",
        sa.Column("promotion_id", sa.String(26), primary_key=True),
        sa.Column("provider", sa.String(64), nullable=False),
        sa.Column("model", sa.String(128), nullable=False),
        sa.Column("config_id", sa.String(128), nullable=False),
        sa.Column("region", sa.String(16), nullable=False),
        ...
        sa.Column("scorecard_ref", sa.String(256), nullable=False),
